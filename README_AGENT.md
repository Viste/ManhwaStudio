...
- committed clean-правки складываются в diff-history как минимальные прямоугольные RGBA-дельты;
  undo/redo в Cleaning применяет их без full-image snapshot-ов, а новый commit после undo отрезает redo-ветку;
...
**Undo**: `BUBBLE_HISTORY_LIMIT` — лимит истории пузырей.
